...
<header id="header" class="header fixed-top d-flex align-items-center shadow-sm">
    ...
    <div class="search-bar d-none">
        <form class="search-form d-flex align-items-center mb-0" method="POST" action="#">
            <input type="text" name="query" placeholder="Search" title="Enter search keyword" id="calendar-search" onkeyup="calendarSearch()">
            <button type="button" title="Search" onclick="calendarSearch()"><i class="bi bi-search"></i></button>
        </form>
    </div><!-- End Search Bar -->
        ...
        <ul class="d-flex align-items-center">
            ...
            <li class="nav-item dropdown pe-3">
                ...
                <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                    <img src="<?= media(); ?>/img/countries/<?= $_SESSION['country_img']; ?>" alt="Profile" class="rounded-circle">
                    <span class="d-none d-md-block dropdown-toggle ps-2"><?= $_SESSION['user'] ?></span>
                </a><!-- End Profile Iamge Icon -->

                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                    <li class="dropdown-header">
                        <img src="<?= media(); ?>/img/usuario.png" width="40" alt="Profile" class="rounded-circle mb-2">
                        <h6><?= $_SESSION['name']." ".$_SESSION['last_name'] ?></h6>
