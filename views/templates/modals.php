...
<div class="modal fade" id="modalAddUser" tabindex="-1" aria-labelledby="modalAddUserLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable p-2">
            ...
            <div class="modal-content rounded-3">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4" id="user-state-cont">
                        ...
                        <div class="mt-4 d-none"><p class="form-label">Assigned sec cust</p></div>
                        <hr class="mt-1 d-none">
                        <div class="row d-none" id="user-sec-custs"></div>
                    </div>
...
<div class="modal fade" id="modalAddRequest" tabindex="-1" aria-labelledby="modalAddRequestLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <form action="#" id="form-request" type="POST">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="modalAddRequestLabel">Add request</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
